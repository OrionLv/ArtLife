...
#import "XBVideoPlayViewController.h"
#import <AVFoundation/AVFoundation.h>
#import "GobelDefine.h"
#import "XBLoadingView.h"

@interface XBVideoPlayViewController ()
...
@implementation XBVideoPlayViewController
...
- (void)viewDidLoad {
    ...
    //添加等待动画
    self.waitView = [[XBLoadingView alloc] initWithFrame:CGRectMake(0, 0, SCREENHEIGHT, SCREENWIDTH)];
    [self.waitView showLoadingViewTo:[UIApplication sharedApplication].keyWindow];
}
...
- (void)monitoringPlayback:(AVPlayerItem *)playerItem
{
    ...
    __weak XBVideoPlayViewController *blockSelf = self;
