...
@interface XBDeilyViewController ()

@end

@implementation XBDeilyViewController
...
- (void)btnClicked{
    ...
    XBVideoPlayViewController *videoPlay = [[XBVideoPlayViewController alloc]init];
